...
[WIND] = LAYOUT_ergodox(  // layer 1 : windows
        ...
        KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,           JP_COLN,
        KC_ENTER,KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,   JP_UNDS,
        LT(MDIA, JP_HENK),  JP_LBRC,JP_RBRC,JP_CIRC,JP_YEN,
KC_LEFT,        KC_RIGHT,
KC_UP,
KC_DOWN,KC_LSFT,ALT_T(KC_ENT)
),
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS,JP_EXLM,JP_DQT,  JP_LCBR,JP_RCBR,JP_PIPE,KC_PGUP,
       KC_TRNS,JP_HASH,JP_DLR, JP_LPRN,JP_RPRN,JP_GRV,
       KC_TRNS,JP_PERC,JP_AMPR,JP_LBRC,JP_RBRC,JP_TILD,KC_PGDN,
...
[MDIA] = LAYOUT_ergodox(
    ...
    // right hand
       ...
       KC_TRNS,  KC_TRNS, KC_WH_L, KC_WH_U, KC_WH_R, KC_TRNS, TG(WIND),
